...
class doover_ui_variable(doover_ui_element):
    ...
    def __init__(self, name, display_str, var_type, curr_val=None, dec_precision=None, ranges=None,  verbose_str=None, show_activity=True, form=None, graphic=None, layout=None):
...
class doover_ui_interaction(doover_ui_element):
    ...
    def __init__(self, name, display_str, is_available=None, help_str=None, verbose_str=None, show_activity=True, form=None, graphic=None, layout=None, default_value=None ):
    ...
    def get_as_dict(self):
        result = doover_ui_element.get_as_dict(self)
        result['type'] = self.get_type()
        result['defaultValue'] = self.get_default_value()

        return result

class doover_ui_action(doover_ui_interaction):

    def __init__(self, name, display_str, is_available=None, help_str=None, colour="blue", requires_confirm=True,  verbose_str=None, show_activity=True, form=None, graphic=None, layout=None, default_value=None ):
    
        doover_ui_interaction.__init__(self, name, display_str, is_available, help_str, verbose_str=verbose_str, show_activity=show_activity, form=form, graphic=graphic, layout=layout, default_value=default_value )
...
class doover_ui_state_command(doover_ui_interaction):
    ...
    def __init__(self, name, display_str, is_available=None, help_str=None, user_options=[], verbose_str=None, show_activity=True, form=None, graphic=None, layout=None, default_value=None ):
...
class doover_ui_float_parameter(doover_ui_interaction):
    ...
    def __init__(self, name, display_str, is_available=None, help_str=None, float_min=None, float_max=None, verbose_str=None, show_activity=True, form=None, graphic=None, layout=None, default_value=None ):
...
class doover_ui_text_parameter(doover_ui_interaction):
    ...
    def __init__(self, name, display_str, is_available=None, help_str=None, is_text_area=False, verbose_str=None, show_activity=True, form=None, graphic=None, layout=None, default_value=None ):
...
class doover_ui_datetime_parameter(doover_ui_interaction):
    ...
    def __init__(self, name, display_str, is_available=None, help_str=None, include_time=False, verbose_str=None, show_activity=True, form=None, graphic=None, layout=None):
        ...
        doover_ui_interaction.__init__(self, name, display_str, is_available, help_str, verbose_str=verbose_str, show_activity=show_activity, form=form, graphic=graphic, layout=layout, default_value=None)
...
class doover_ui_time_parameter(doover_ui_interaction):
    ## datetime is stored as epoch seconds UTC
...
class doover_ui_slider(doover_ui_interaction):
    ...
    def check_min_max(self):
        if self.min is None or self.max is None:
            raise ValueError(str(self.name) + "- Slider min and max must be set")
        return True
    ...
    def get_as_dict(self):
        ...
        result['min'] = self.get_min()
        result['max'] = self.get_max()
        result['stepSize'] = self.get_step_size()
        result['dualSlider'] = self.get_dualSlider()
        result['isInverted'] = self.get_isInverted()
    ...
    def get_dualSlider(self):
        return self.dual_slider

    def get_step_size(self):
        return self.step_size
    
    def get_isInverted(self):
        return self.is_inverted

    def set_min(self, slider_min):
        self.slider_min = slider_min

    def set_max(self, slider_max):
        self.slider_max = slider_max

    def set_dualSlider(self, dual_slider):
        self.dualSlider = dual_slider

    def set_step(self, slider_step):
...
class doover_ui_container(doover_ui_element):
    ...
    def __init__(self, name, display_str, is_available=None, help_str=None, children=[], status_icon=None, verbose_str=None, show_activity=True, form=None, graphic=None, layout=None ):
        ...
        doover_ui_element.__init__(self, name, display_str, is_available=is_available, help_str=None, verbose_str=verbose_str, show_activity=show_activity, form=form, graphic=graphic, layout=layout)
...
class doover_ui_submodule(doover_ui_container):
    ...
    def __init__(self, name, display_str, is_available=None, help_str=None, children=[], status_string=None, collapsed=False, status_icon=None, verbose_str=None, show_activity=True, form=None, graphic=None, layout=None ):

        doover_ui_container.__init__(self, name, display_str, is_available=is_available, help_str=help_str, children=children, status_icon=status_icon, verbose_str=verbose_str, show_activity=show_activity, form=form, graphic=graphic, layout=layout )
